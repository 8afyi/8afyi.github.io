...
* Can't mute for a pre-set amount of time. I want to mute a chat for one day, or one week.
* No web interface. The only Mac I have is my work Mac which, obviously, uses a different Apple ID. I do not have a stable way to access Messages other than on my one iPhone. 
* 